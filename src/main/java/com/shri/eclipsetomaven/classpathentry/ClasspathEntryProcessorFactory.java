...
public class ClasspathEntryProcessorFactory {
    ...
    public static ClasspathEntryProcessor create(Element classpathEntryElement) {
        String combineaccessrulesAttribute = classpathEntryElement
                .getAttribute(ClasspathConstants.COMBINEDACCESSRULES_ATTR);

        String kindAtt = classpathEntryElement
                .getAttribute(ClasspathConstants.KIND_ATTRIBUTE);
        String exportedAttribute = classpathEntryElement
        ...
        if (ClasspathConstants.FALSE.equals(combineaccessrulesAttribute)
                && ClasspathConstants.SRC_ATTR.equals(kindAtt)) {
            return new CombinedaccessrulesFalseClasspathEntryProcessor();
        } else if (ClasspathConstants.TRUE.equals(exportedAttribute)
                && ClasspathConstants.LIB_ATTR.equals(kindAtt)) {
        ...
        } else if (ClasspathConstants.SRC_ATTR.equals(kindAtt)
                && !pathAtt.startsWith("/")) {
